...
export const imageSlots = [
  ...
  imageSlot('feature-01','features','Productfoto 1','Lifestyle productfoto · product in gebruik · resultaat zichtbaar','1:1'),
  imageSlot('feature-02','features','Productfoto 2','Detailfoto · eigenschap en mechanisme · tastbare kwaliteit','1:1'),
  imageSlot('feature-03','features','Productfoto 3','Contextfoto · realistische omgeving · schaal en gemak','1:1'),
  ...
  imageSlot('review-01','reviews','Reviewfoto 01','Klant met product · mobiele UGC-look','1:1'),
  imageSlot('review-02','reviews','Reviewfoto 02','Product thuis · imperfect en geloofwaardig','1:1'),
  imageSlot('review-03','reviews','Reviewfoto 03','Close-up resultaat · natuurlijk licht','1:1'),
  imageSlot('expert-photo','reviews','Expertfoto','Echte portretfoto · neutrale achtergrond','1:1'),
  imageSlot('faq-photo','faq','FAQ-productfoto','Product in rustige context · herkenbare schaal','1:1'),
  imageSlot('final-thumbnail','final','Productthumbnail','Vrijstaand product · frontaal','1:1'),
];

export const stores = Object.fromEntries(['dieren','beauty','gadgets','wellness','fashion','wonen','kids','outdoor'].map((slug) => [slug, {
  slug,
