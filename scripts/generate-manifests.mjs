...
const masterPrompt = `BELANGRIJK: bouw uitsluitend een schone klantgerichte merchant-storefront. Clone of render NOOIT de volledige DSA-app. Lees eerst STOREFRONT.md en daarna public/base44.json en dit route-manifest. Gebruik de repository als ontwerp- en datareferentie. Neem geen DSA-toolbar, DSA-branding, leerlaag, promptmodals, machine-content, GitHub/Base44-uitleg of demowinkelmand over. Gebruik bouwmetadata tijdens het genereren maar verwijder die uit de productie-DOM. Vraag eerst om ontbrekende productdata en vervang alleen placeholders met aangeleverde, verifieerbare informatie. Behoud de klantgerichte secties, interacties en 1:1 beeldverhoudingen. Verzin nooit claims, prijzen, voorraad, reviews, experts, keurmerken of garanties.`;
const manifest = {
  schemaVersion: '5.0',
  ...
  aiContract: {
    ...
    hardRules: ['Geen DSA-studio, DSA-branding of AI-uitleg in de winkel','Behoud de klantgerichte layout en sectievolgorde','Alle afbeeldingen exact 1:1','Geen verzonnen feiten of social proof','Alle klantcontrols toetsenbordtoegankelijk','Bouwmetadata consumeren maar niet renderen'],
...
const base44Package = {
  ...
  repairWorkflow,
  requiredInputs,
  buildRules:['Lees STOREFRONT.md vóór het openen of kopiëren van src/App.jsx','Gebruik de repository als ontwerp- en datareferentie; clone de complete app niet naar de uitvoer','Behoud de klantgerichte sectievolgorde, responsive layout en interacties','Vervang uitsluitend placeholders met aangeleverde, verifieerbare productdata','Gebruik data-ai-*, data-learn-record en data-visible-slot tijdens de bouw en verwijder bouwmetadata uit de productie-DOM','Alle zichtbare afbeeldingen zijn exact 1:1','Gebruik Lucide voor winkeliconen en de meegeleverde Datatrans-betaallogo’s','Voer npm test uit voor oplevering'],
  forbidden:['DSA-toolbar, DSA-branding, leerlaag, promptmodals, machine-content, GitHub/Base44-uitleg of demowinkelmand in de storefront','Verzonnen claims, prijzen, voorraad, reviews, experts, keurmerken, levertijden of garanties','Een screenshot gebruiken als enige bouwbron','Afbeeldingen met een andere verhouding dan 1:1','Bouwmetadata als zichtbare inhoud of productie-DOM exporteren'],
  acceptanceCriteria:['De gekozen categorie, palette en font zijn als initiële merchant-stijl toegepast zonder zichtbare configuratiecontrols','De desktop- en mobiele layout blijven responsief','Galerij, bundels, accordeons, FAQ, winkelmand en mobiele CTA zijn klikbaar','Officiële betaallogo’s laden als afbeeldingen','Alle placeholders komen uit aangeleverde input','De zichtbare tekst bevat geen DSA-, Base44-, GitHub-, AI-, prompt-, template-, leerlaag-, scrape- of demotekst','npm test slaagt zonder fouten'],
};
